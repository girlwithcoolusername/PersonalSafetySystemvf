...
import com.example.personalsafetysystem.databinding.FragmentPoliceBinding;
import com.example.personalsafetysystem.databinding.PoliceListItemBinding;
...
public class PoliceFragment extends Fragment {
    ...
    class PoliceAdapter extends RecyclerView.Adapter<PoliceAdapter.PoliceViewHolder>{
        @NonNull
        @Override
        public PoliceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new PoliceViewHolder(PoliceListItemBinding.inflate(getLayoutInflater(), parent, false));
        }
    ...
    PolicesListener mListener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        mListener = (PolicesListener) context;
    }
